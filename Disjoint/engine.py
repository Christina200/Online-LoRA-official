    ...
    for task_id in range(args.num_tasks):
        for _, data in enumerate(data_loader[task_id]['train']):
                ...
                if len(batch) == args.nb_batch:
                    ...
                    if task_id is not 0 and loss_window_mean < args.loss_window_mean_threshold and loss_window_variance < args.loss_window_variance_threshold and new_peak_detected:
                        count_updates+=1
